...
final class CastListView: UIView, UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
    ...
    private var labelTitle: AppLabel = {
        ...
        label.text = LocalizableKeys.MovieDetail.cast.getLocalized()
        return label
    }()
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        cell.save(
            ...
            description: cast.character ?? Constant.StringParameter.EMPTY_STRING
        )
        return cell
    }
